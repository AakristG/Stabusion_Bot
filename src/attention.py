...
class SelfAttention(nn.Module):
    ...
    def forward(self, x: torch.Tensor, casual_mask=False):
        ...
        if casual_mask:
            #Mask where the upper traingle (above the principal diagonal) is made of 1
    ...
    class CrossAttention(nn.Module):
        ...
        def forward(self, x, y):
            ...
            # y: (context) (Batch_Size, Seq_Len, KV, Dim_KV) = (Batch_Size, 77, 768)
            ...
            output = output.tranpose(1, 2).contiguous()
